            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "img/<?php echo $p['gambar'];?>" alt = "HP">
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name"><?php echo $p['nama'];?></span>
                    <span class = "product-price">Rp <?php echo $p['harga'];?></span>
                    <span class = "product-kategori">Kategori :  <?php echo $p['kategori'];?></span>
                    <p class = "product-description"><?php echo $p['deskripsi'];?></p>
