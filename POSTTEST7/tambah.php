<?php
    ...
    if (isset($_POST["tambah"])) {
        ...
        if(move_uploaded_file($temp, 'img/' . $gambar_baru)){
            $query = mysqli_query($conn, "INSERT INTO barang VALUES ('$merk', $stok, '$gambar_baru', '$spek', '$waktu')");
            if($query){
                echo"
                    <script>
        ...
        <div class="form">
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="order-detail">
                    ...
                    <div class="input">
                        <span class="detail"> Spesifikasi Lengkap </span>
                        <textarea name="spesifikasi" placeholder="Masukkan Spesifikasi Lengkap" required> </textarea>
                    </div>
                    <div class="input">
